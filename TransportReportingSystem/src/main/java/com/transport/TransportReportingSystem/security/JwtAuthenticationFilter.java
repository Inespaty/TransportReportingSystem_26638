...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // We ignore this and proceed, allowing the request to continue unauthenticated.
            // This is crucial for endpoints like /login that might be called with a stale token.
        }
        filterChain.doFilter(request, response);
    }
}
